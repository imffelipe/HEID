    ...
    <div class="container">
        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-7 anim-fade-up">
                ...
                <h1 class="page-title">Protección <span class="highlight-green">infantil</span><br>en tiempo real</h1>
                <p class="page-subtitle">Detección de grooming y ciberacoso en chats y juegos en línea. Alertas discretas a padres sin invadir la privacidad del menor.</p>
        ...
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6">
                <div class="privacy-box" style="border-color:rgba(0,255,136,0.2)">
                    ...
                    <p style="color:var(--heid-text-dim);font-size:0.9rem;">HEID Kids <strong style="color:#fff;">nunca almacena ni transmite</strong> el contenido de las conversaciones. Solo genera una señal de alerta cuando detecta un patrón de riesgo. El análisis ocurre completamente en el dispositivo.</p>
                    <div class="pb-stats">
                        <div class="pb-stat">
...
.module-visual { width:200px; height:200px; position:relative; display:flex; align-items:center; justify-content:center; font-size:4rem; color:var(--heid-green); filter:drop-shadow(0 0 30px rgba(0,255,136,0.3)); animation:float 3s ease-in-out infinite; }
.visual-ring { position:absolute; border-radius:50%; border:1px solid rgba(0,255,136,0.2); animation:expand 3s infinite ease-out; }
...
.privacy-box { background:var(--heid-bg-card); border:1px solid; border-radius:16px; padding:2rem; }
