...
<div class="page-hero">
    ...
    <div class="container">
        ...
        <div class="col-lg-7 anim-fade-up">
            ...
            <h1 class="page-title" style="color:#fff;">Tecnología <span class="highlight-cyan">Edge AI</span><br>al servicio humano</h1>
            <p class="page-subtitle">HEID corre completamente en tu dispositivo. La inteligencia artificial analiza, detecta y protege sin enviar ningún dato a servidores externos.</p>
        </div>
    </div>
</div>
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-lg-8">
                <div class="privacy-statement">
                    ...
                    <div>
                        <h4 style="color:#fff;font-family:var(--font-display);margin-bottom:0.75rem;">Tus datos nunca salen de tu dispositivo</h4>
                        <p style="color:var(--heid-text-dim);font-size:0.92rem;margin:0;">HEID está construido bajo el principio de <strong style="color:#fff;">Privacy by Design</strong>. Todos los modelos de IA se ejecutan localmente usando Edge AI. No existe ningún servidor que reciba tu información. No hay telemetría, no hay perfilado, no hay almacenamiento en la nube.</p>
                    </div>
                </div>
            </div>
        </div>
...
.privacy-statement { background:var(--heid-bg-card); border:1px solid rgba(0,229,255,0.15); border-radius:16px; padding:2rem; display:flex; align-items:flex-start; gap:1.5rem; }
.ps-icon { font-size:2rem; color:var(--heid-cyan); flex-shrink:0; }
.priv-pill { background:var(--heid-bg-card); border:1px solid var(--heid-border); border-radius:10px; padding:1rem; display:flex; flex-direction:column; align-items:center; gap:0.5rem; text-align:center; font-family:var(--font-mono); font-size:0.72rem; color:var(--heid-text-dim); transition:border-color 0.2s; }
